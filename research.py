...
class DashboardUI:
    ...
    def create_sidebar(self) -> Tuple[str, int, str, str, str, str, str]:
        with st.sidebar:
            ...
            with col1:
                ...
                main_chart_color = st.color_picker("Chart Color", "#1f77b4")

            with col2:
                st.subheader("Comparison")
                comparison_query = st.text_input("Query", value="machine learning")
                comparison_chart_color = st.color_picker("Chart Color", "#ff7f0e")
    ...
    def plot_sentiment_trends(
        ...
        main_chart_color: str,
        comparison_chart_color: str,
    ):
        ...
        with col1:
            base_chart = (
                ...
                .encode(
                    x="date:T",
                    y="polarity:Q",
                    color=alt.value(main_chart_color),
        ...
        with col2:
            comparison_chart = (
                ...
                .encode(
                    x="date:T",
                    y="polarity:Q",
                    color=alt.value(comparison_chart_color),
                    tooltip=["title", "polarity", "date"],
                )
        ...
        with col4:
            fig2 = px.box(
                ...
                color_discrete_sequence=[comparison_chart_color],
            )
        ...
        with st.spinner("Fetching papers..."):
            ...
            if papers and comparison_papers:
                ...
                self.plot_sentiment_trends(
                    df, comparison_df, main_chart_color, comparison_chart_color
                )
